...
imgui_sdl2::Application::Application(const char *title, const int width, const int height)
{
...
void imgui_sdl2::Application::update()
{
...
void imgui_sdl2::Application::render()
{
    ImGui::Render();
...
imgui_sdl2::Application::~Application()
{
    // Destruction!!!!!!!!!!!
